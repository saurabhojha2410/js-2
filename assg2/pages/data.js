...
for (let key in data[0].categories) {
    ...
    // Add a click event listener to redirect to game.html with the category as a URL parameter
    category.addEventListener('click', () => {
        window.location.href = `playground.html?category=${encodeURIComponent(key)}`;
    });
